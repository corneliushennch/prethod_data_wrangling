...
```{r timeline, fig.width=8,fig.height=4}
...
**Comment:** This repository aspires to meet the principles of a [research compendium](https://the-turing-way.netlify.app/reproducible-research/compendia.html?highlight=compendium "Research Compendia (The Turing way)").
